 ...
 * @since 2.0
 */
public class GeoTag extends FragmentActivity implements
    ...
    public void testKinveyService() {
        mKinveyClient.ping(new KinveyPingCallback() {
            ...
            public void onSuccess(Boolean result) {
                Toast.makeText(GeoTag.this, "kinvey ping success!", Toast.LENGTH_LONG).show();
            }

            @Override
            public void onFailure(Throwable throwable) {
                Toast.makeText(GeoTag.this, "kinvey ping failed, check res/strings for appkey and appsecret", Toast.LENGTH_LONG).show();
            }
        });
    }
